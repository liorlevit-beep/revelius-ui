      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">
            Payments fail when context is missing.
          </h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            {/* Box 1: The Problem */}
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 rounded-xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="flex items-start">
                    ...
                    <span>Static categories</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-red-500 mr-3 mt-1">✕</span>
                    <span>Shallow risk signals</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-red-500 mr-3 mt-1">✕</span>
                    <span>One-time onboarding checks</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Box 2: The Reality */}
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-300 rounded-xl p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-200 rounded-full blur-3xl opacity-40 -mr-16 -mt-16"></div>
              <div className="relative">
                <div className="text-sm font-bold text-amber-700 uppercase tracking-wide mb-4">
                  Modern Reality
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    What they sell, how they sell it, and how they present themselves <strong className="text-gray-900">changes constantly</strong>.
                  </p>
            ...
            {/* Box 3: The Solution */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-400 rounded-xl p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-200 rounded-full blur-3xl opacity-40 -mr-16 -mt-16"></div>
              <div className="relative">
                <div className="text-sm font-bold text-blue-600 uppercase tracking-wide mb-4">
                  Revelius Solution
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="flex items-start">
                    ...
                    <span>Continuous business scanning</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <span>Structured context intelligence</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <span>Actionable payment decisions</span>
                  </div>
                </div>
              </div>
            </div>
