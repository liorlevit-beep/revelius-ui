        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Most routing and risk decisions are made using rigid snapshots.
              Revelius connects them to the live business reality.
            </p>
          </div>
                  ...
                  <div className="relative z-10">
                    <div className="text-center mb-6">
                      ...
                      <h3
                        ...
                        style={{ color: "rgba(229, 231, 235, 1)" }}
                      >
                      ...
                      >
                        We continuously discover what a business does, translate
                        it into explainable signals, and feed it into routing,
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex items-start">
                        ...
                        <span style={{ color: "rgba(229, 231, 235, 0.9)" }}>
                          Actionable decisions with evidence
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3 flex-col sm:flex-row justify-center">
                      <Link
                        ...
                        style={{
                          ...
                          backdropFilter:
                            "blur(12px) saturate(1.5) contrast(1.1)",
                      ...
                      <Link
                        ...
                        onMouseLeave={(e) => {
                          e.currentTarget.style.border =
                            "1.5px solid rgba(229, 231, 235, 0.4)";
