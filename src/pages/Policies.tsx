...
export function Policies() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header title="Policies (Pillar)" timeRange="7" onTimeRangeChange={() => {}} />
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-gray-500 uppercase w-24">Regions</span>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-gray-500 uppercase w-24">Goal</span>
                    <span className="text-sm font-medium text-gray-900">{pack.primaryGoal}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-gray-500 uppercase w-24">Rules</span>
                    <span className="text-sm text-gray-700">{pack.rulesCount} active rules</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-gray-500 uppercase w-24">Updated</span>
                    <span className="text-sm text-gray-700">{getRelativeTime(pack.lastUpdated)}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
        ...
        {filteredPacks.length === 0 && (
          <Card className="p-12">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No policy packs found</h3>
